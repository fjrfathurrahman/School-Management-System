 ...
 */
export function FormAddStudent({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
    ...
    const inputFields = [
        ...
        },
        {
            ...
            options: academic?.classes.map((classroom) => ({
        ...
        },
        {
            ...
            options: academic?.majors.map((major) => ({
